    ...
    <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="nav navbar-nav text-light" id="accordionSidebar">
            <li class="nav-item" role="presentation">
                <a class="nav-link @if($pages=='dash') active @endif" href="{{route('admin')}}"><i class="fas fa-tachometer-alt"></i><span>&nbsp;Beranda</span></a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link @if($pages=='trans') active @endif" href="{{ route('transaction.index') }}"><i class="fas fa-exchange-alt"></i><span>&nbsp;Transaksi</span></a>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse @if($pages=='ulist' || $pages=='uadd') show @endif" id="collapse-1">
                    <div class="bg-white border rounded py-2 collapse-inner">
                        <a class="collapse-item @if($pages=='ulist') active @endif" href="{{ route('user.index') }}">Daftar User</a>
                        <a class="collapse-item @if($pages=='uadd') active @endif" href="{{ route('user.create') }}">Tambah User</a>
                    </div>
                </div>
            </li>
            {{--<li class="nav-item" role="presentation">--}}
