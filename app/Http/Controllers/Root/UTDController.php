...
class UTDController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('root.utd.index', compact('pages', 'utds', 'city'));
    }
    ...
    public function create()
    {
        $pages = 'utdadd';
        $city = City::pluck('nama','id')->all();
        return view('root.utd.add', compact('pages','city'));
    }
    ...
    public function show($id)
    {
        ...
        $pages = 'utdlist';
        return view('root.utd.show', compact('pages', 'utd', 'transs', 'jadwals', 'joins'));
    }
