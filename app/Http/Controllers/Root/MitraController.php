...
class MitraController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('root.mitra.index', compact('pages', 'mitras','city'));
    }
    ...
    public function create()
    {
        $pages = 'mitadd';
        $city = City::pluck('nama','id')->all();
        return view('root.mitra.add', compact('pages', 'city'));
    }
    ...
    public function show($id)
    {
        ...
        $pages = 'mitlist';
        return view('root.mitra.show', compact('vouchers','pages','mitra'));
    }
